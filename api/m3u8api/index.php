...
<head>
    ...
    <link rel="stylesheet" href="./static/new/github-markdown-css.css">
    <script src="./static/new/flv.min.js"></script>
    <script src="./static/new/flv.js"></script>
    <script src="./static/new/hls.min.js"></script>
    <script src="./static/new/hls.js"></script>
    <script src="./static/new/dash.all.min.js"></script>
    <script src="./static/new/webtorrent.min.js"></script>
    <script src="./static/new/pearplayer.js"></script>
    <script src="./static/new/DPlayer.min.js"></script>
